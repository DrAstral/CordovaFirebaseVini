            ...
            'SELECT nome AS uNome, telefone AS uTelefone, origem AS uOrigem, data_contato AS uDataContato, observacao AS uObservacao FROM clientes', [], function(rs) {
                ...
                for(i = 0; i < rs.rows.length; i++){
                    ...
                    $("#TableData").append("<td scope='col'><a href='" + cordova.file.applicationDirectory + 
                        "www/editarClientes.html?telefone=" + rs.rows.item(i).uTelefone + "'>Editar</a>&nbsp;|&nbsp;<a href='" + cordova.file.applicationDirectory + 
                        "www/excluirClientes.html?telefone=" + rs.rows.item(i).uTelefone + "'>Excluir</a></td>");
                    $("#TableData").append("</tr>");
                }
